        ...
        <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row'>
            ...
            <div className='flex flex-col flex-1 p-3'>
                ...
                <div className='flex gap-4 p-3'>
                    ...
                    <button type='button' onClick={handleImageSubmit} disabled={uploading} className='p-3 text-green-700 border border-green-700 uppercase hover:shadow-lg disabled:opacity-80'>{uploading? 'Uploading...': 'Upload'}</button>

                </div>
                <p className='text-red-700 text-sm p-3'>{imageUploadError && imageUploadError}</p>
                {
